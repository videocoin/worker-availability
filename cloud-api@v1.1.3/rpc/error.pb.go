...
func (*ValidationError) XXX_MessageName() string {
	return "cloud.api.rpc.ValidationError"
}
...
func (*MultiValidationError) XXX_MessageName() string {
	return "cloud.api.rpc.MultiValidationError"
}
func init() {
	proto.RegisterType((*ValidationError)(nil), "cloud.api.rpc.ValidationError")
	golang_proto.RegisterType((*ValidationError)(nil), "cloud.api.rpc.ValidationError")
...
func (m *MultiValidationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
